...
class SimpleReportGenerator:
    ...
    def _write_report_header(self, f, result: Dict):
        """Write report header."""
        f.write("=" * 60 + "\n")
        f.write("🛡️  DEEPFAKE DETECTION REPORT\n")
        f.write("=" * 60 + "\n\n")
    ...
    def _write_detection_results(self, f, result: Dict):
        ...
        if prediction == 'Real':
            if confidence > 0.8:
                interpretation = "✅ The file appears to be authentic with high confidence."
            else:
                interpretation = "⚠️ The file appears to be authentic, but confidence is moderate."
        else:  # Fake
            if confidence > 0.8:
                interpretation = "❌ The file is likely manipulated with high confidence."
            else:
                interpretation = "⚠️ The file may be manipulated, but confidence is moderate."
